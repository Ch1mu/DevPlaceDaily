...
public class TicketController {
    ...
    public ResponseEntity save(@RequestBody Ticket tickets)
    {
        try
        {
            ...
            Product p = pS.getById(c.getProd().getCode());
            Email email = new Email("email@email.com"," Ticket Code: "+ c.getNTicket() + ", Product: " + p.getName() + ", Ammount: " + c.getAmmountProducts()  ,"Your Ticket");
